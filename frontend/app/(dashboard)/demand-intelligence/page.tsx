  ...
  const scorecards = [
    {
      ...
      changePeriod: defaultKpis?.critical_stockout?.changePeriod || "vs minggu lalu",
    ...
    },
    {
      ...
      changePeriod: defaultKpis?.forecast_accuracy?.changePeriod || "vs bulan lalu",
      isPositiveGood: true,
    ...
    },
    {
      ...
      changePeriod: defaultKpis?.spare_part_readiness?.changePeriod || "vs bulan lalu",
      isPositiveGood: true,
    ...
    },
    {
      ...
      changePeriod: defaultKpis?.inventory_imbalance?.changePeriod || "vs bulan lalu",
      isPositiveGood: false,
